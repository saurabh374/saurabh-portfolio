      ...
      <section id="projects" className="relative z-10 mt-32 p-6 text-slate-900">
        ...
        <div id="projects-container" className="mb-6 flex flex-col gap-6">
          ...
          {projects.map((project) => <div data-aos="fade-left">
            <div key={project.id} className="wrapper flex flex-col gap-4 rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
