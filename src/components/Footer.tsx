      ...
      <div className="mx-auto max-w-[630px] px-6">
        ...
        <div className="wrapper rounded-[30px] border-[3px] border-slate-900 p-8 shadow-[4px_4px_0px_0px_#1e293b]">
          ...
          <div className="mb-8 flex justify-center gap-4">
            ...
            <Link
              href="https://linkedin.com/in/iamsaurabhp"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border-2 border-slate-900 bg-white p-3 shadow-[3px_3px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:bg-slate-900 hover:text-white hover:shadow-none"
              aria-label="LinkedIn"
          ...
          <nav className="mb-6 flex flex-wrap justify-center gap-4 text-sm md:gap-6">
            <Link href="/#projects" className="transition-colors hover:text-lime-500">
              Projects
            </Link>
            <Link href="/#tech-stack" className="transition-colors hover:text-lime-500">
              Tech Stack
            </Link>
            <Link href="/blog" className="transition-colors hover:text-lime-500">
              Blog
            </Link>
            <Link href="/#contact" className="transition-colors hover:text-lime-500">
              Contact
            </Link>
            <Link href="/resume.pdf" target="_blank" className="transition-colors hover:text-lime-500">
              Resume
            </Link>
            <Link href="/terms" className="transition-colors hover:text-lime-500">
              Terms
            </Link>
          </nav>
          ...
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-slate-600 md:flex-row">
            <p>© {currentYear} Saurabh Patil. All rights reserved.</p>
