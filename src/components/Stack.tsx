...
const frontend = [
  ...
  { path: "react_query.svg", name: "TanStack Query" },
...
const backend = [
  ...
  { path: "php.svg", name: "PHP" },
  { path: "rabbitmq.svg", name: "RabbitMQ" },
  { path: "redis.svg", name: "Redis" },
  { path: "mysql.svg", name: "MySQL" },
...
const misc = [
  ...
  { path: "docker.svg", name: "Docker" },
  { path: "githubactions.svg", name: "Github Actions" },
  { path: "flutter.svg", name: "Flutter" },
];
    ...
    <AOSComponent>
      ...
      >
        ...
        <div className="stack-wrapper flex grid-cols-[2.2fr_0.9fr] grid-rows-[1fr_1fr] flex-col gap-6 md:grid">
          <div data-aos="fade-right" className="col-start-1 col-end-2 row-start-1 row-end-2">
          ...
          <div data-aos="fade-right" className="col-start-1 col-end-2 row-start-2 row-end-3">
            <div className="wrapper rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
          ...
          <div data-aos="fade-up" className="col-start-2 col-end-3 row-start-1 row-end-3 md:h-full">
