...
export default function Contact() {
  ...
  async function sendEmail(_formdata: FormData) {
    ...
    const emailPromise = emailjs
      .send(
        "service_ihdbf1k",      // your EmailJS service ID
        "template_emveg2m",     // your EmailJS template ID
        {
          name,
          email,
          message,
        },
        "sfoHxWhB9Hm7oLa6j"     // your EmailJS public key
      )
      .then(() => {
        setName("");
        setEmail("");
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="max-w-[600px] rounded-[30px] border-[2px] border-slate-900 bg-slate-900 px-6 py-4 text-sm font-medium text-white shadow-[4px_4px_0px_0px_#84cc16] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none disabled:cursor-not-allowed disabled:opacity-70 md:text-xl"
          >
